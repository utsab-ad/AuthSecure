...
const Sidebar = () => {
  ...
  return (
    <div className="flex w-full">
      <div
        className={`fixed block md:hidden top-0 left-0 h-full  w-15 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 transition-width duration-300 text-white 
        ${isOpen ? "w-74 " : "w-15"}
        `}
      >
          ...
          <ul>
            ...
            className="flex items-center p-4 hover:bg-gray-700 cursor-pointer">
              ...
              >
                ...
                <span
                  className={`ml-4 ${isOpen ? "block flex flex-col items-center" : "hidden" }`}
                >
            ...
            <li className="flex w-full p-4 items-center hover:bg-gray-700 cursor-pointer">
              <FaFacebookF
                size={24}
      ...
      <div
        className={`fixed hidden md:block top-0 left-0 h-full w-74 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 transition-width duration-300 text-white`}
      >
        <div className="flex justify-between items-center p-4">
            <Link
          to={RouteIndex}
          ...
          {user && user.isLoggedIn ? (
            <>
              <Link className={`font-medium ml-4 `}>
                <HiPencilAlt size={24} />
              </Link>
            </>
          ) : (
        ...
        <nav className="mt-4">
          <ul>
              ...
              <div className={` flex flex-col mx-auto items-center gap-4`}>
                <div>
                  <Avatar>
                    <AvatarImage
                      src="https://github.com/shadcn.png"
                      className={`border-2 border-black  md:rounded-full`}
                    />
                    <AvatarFallback>CN</AvatarFallback>
                  </Avatar>
                </div>
                <span className={`ml-4 block flex flex-col items-center`}>
                  <h3 className="text-2xl font-bold">Utsab Adhikari</h3>
                  <Badge variant="outline" className={`bg-violet-600`}>
                    Fullstack Developer
                  </Badge>
            ...
            <li className="flex items-center p-4 hover:bg-gray-700 cursor-pointer w-full">
              ...
              <div
                className={`flex items-center justify-between w-full ml-4 pr-4 flex`}
              >
                <a
                  href={`tel:+9779867508725`}
                  className="text-blue-600 hover:underline"
            ...
            <li className="flex items-center p-4 hover:bg-gray-700 cursor-pointer w-full">
              ...
              {/* Text and Add Button Wrapper */}
              <div
                className={`flex truncate items-center justify-between w-full ml-4 pr-4 flex`}
              >
                <a
                  href={`mailto:utsabadhikari075@gmail.com`}
                  className="text-blue-600 hover:underline "
      ...
      <div
      onClick={() => setIsOPen(false)}
      className="flex ml-15 md:ml-74 flex-1 flex-col bg-gradient-to-br from-gray-50 via-blue-100 to-white dark:from-gray-900 dark:via-slate-800 dark:to-gray-950 text-gray-800 dark:text-white ">
        <button
          onClick={() => navigate(-1)}
          className={`fixed md:left-73 left-15
                   m-2 px-4 py-2 hover:text-stone-600 top-0 ${
                     isOpen || isIndexRoute ? "hidden" : "block"
                   }`}
        >
          <IoMdArrowRoundBack />
        </button>
