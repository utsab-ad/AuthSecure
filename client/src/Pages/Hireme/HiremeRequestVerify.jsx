...
import BackNavigation from "@/Buttons/BackNavigation.jsx";
import HomeNavigation from "@/Buttons/HomeNavigation.jsx";

const HiremeRequestVerify = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        `${import.meta.env.VITE_API_BASE_URL}/otp/verifyrequest`,
        {
          email,
          otp,
        },
      ...
      .then(() => {
        navigate(RouteTrackApplication);
      })
      ...
      <div className="max-w-sm mx-auto mt-10 flex flex-col items-center justify-center bg-white shadow-xl border border-gray-200 rounded-2xl p-6">
        ...
        <div className="w-[80%] flex justify-center items-center pb-2">
          <p className="text-sm  text-center">
            Please check your email and paste the OTP verification
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            <button className="ml-1 text-indigo-600 font-semibold hover:underline cursor-pointer">
              Resend OTP →
            </button>
          </p>
        </div>
...
export default HiremeRequestVerify;
