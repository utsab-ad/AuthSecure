...
export const htmlHireme = (companyName, otp) => {
    return `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f6f9; padding: 40px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 8px; padding: 30px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
...
export const htmlDeleterequest = (companyName, otp) => {
    return `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f6f9; padding: 40px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 8px; padding: 30px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
          <h1 style="color: #2c3e50; text-align: center;">Hello, ${companyName} 👋</h1>
          <hr style="border: none; border-top: 1px solid #ddd; margin: 20px 0;" />
          <h2 style="color: #007BFF;">Verify Your Email Address for Deletion</h2>
          <p style="font-size: 16px; color: #333;">
            Thank you for request. For further procedure, please use the following One-Time Password (OTP) to verify your email address:
          </p>
          <div style="text-align: center; margin: 30px 0;">
...
export const htmlAccepted = () => {
    return `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f6f9; padding: 40px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 8px; padding: 30px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
          <h1 style="color: #2c3e50; text-align: center;">Offer Accepted </h1>
          <hr style="border: none; border-top: 1px solid #ddd; margin: 20px 0;" />
          <p style="font-size: 16px; color: #333;">
            Thank you for Offer, For further Procedure Utsab Adhikari will intereact with You !
          </p>
          <div style="text-align: center; margin: 30px 0;">
            <span style="font-size: 28px; font-weight: bold; color: #2d3436; letter-spacing: 4px;">Thank You !</span>
          </div>
          <p style="font-size: 14px; color: #999;">
            If you didn’t initiate this request, you can safely ignore this email.
          </p>
